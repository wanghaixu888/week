...
public class RandomStringutil {
	...
	//TODO 实现代码
		...
		for (int i = 0; i < length; i++) {
			src += (char)(r.nextInt(40369-19968+1)+19968)+"";
		}
		return  src;
	}
	...
	//TODO 实现代码s
		Random r = new Random();
		int i = r.nextInt(Surname.length-1);
	...
	public static String getRandomString() {
		Random r = new Random();
		return (char)(r.nextInt(40369-19968+1)+19968)+"";
	}
}
